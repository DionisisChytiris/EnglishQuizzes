        ...
        <div className='trivia'>
            ...
            <div>
                ...
                <div className='showscore-btns'>
                    <a href="/quiz11" className='return'>Try Again</a>
                    <a href="/quiz12" className='return'>Next Quiz</a>
                </div>
            </div>
            ) :
            (
            <>
                ...
                {/* <div className="quiz4-count">
                    Question {currentQuestion + 1} of {quiz3data.length}
                    <br/>
                    Score {score} / {  quiz3data.length}
                </div> */}
