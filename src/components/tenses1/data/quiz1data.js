const quiz1data = [
    {
      ...
      answersList: [
        ...
        {answer: "am starting", isCorrect: false},
      ],
   ...
   },
    {
      ...
      answersList: [
        ...
        {answer: "boils", isCorrect: true}
      ],
      help: 'We use present simple to talk about things that are always true. ',
   ...
   },
    {
      ...
      answersList: [
        ...
        {answer: "am drinking", isCorrect: false},
      ],
   ...
   },
    {
      ...
      answersList: [
        ...
        {answer: "is increasing", isCorrect: true},
      ],
   ...
   },
    {
      ...
      answersList: [
        ...
        {answer: "am going", isCorrect: false},
      ],
   ...
   },
    {
      ...
      answersList: [
        ...
        {answer: "is going", isCorrect: false},
      ],
      help: 'We use present simple to talk about things that are always true.'
   }
  ]
