...
const OpenClose_2 = () => {
    ...
    return (
        <>
            <div className='trivia-openCloze1'>
                ...
                <div className='open-close'>
                    <div>Cats of all kinds are present in the legends, religion, mythology, and history of 
                        ...
                        <p className={ tick1 ? 'active' : 'close'}>
                    ...
                    <span>
                        ...
                        <p className={ tick2 ? 'active' : 'close'}>
                        ...
                        <p className={ tick3 ? 'active' : 'close'}>
                            {name3 === 'to' ? green : red}
                        </p>
                        ...
                        <p className={ tick4 ? 'active' : 'close'}>
                        ...
                        <p className={ tick5 ? 'active' : 'close'}>
                        ...
                        <p className={ tick6 ? 'active' : 'close'}>
                            {name6 === 'so' ? green : red}
                        </p>
            ...
            <a href='/openClose2'>Try Again</a>
        </>    
    )
}

export default OpenClose_2
